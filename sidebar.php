...
<script>
var s1 = '<?php echo wintery('bloginfo-birth')?>';//设置为你的建站时间
s1 = new Date(s1.replace(/-/g, "/"));
s2 = new Date();
var bloginfobirth = s2.getTime() - s1.getTime();
var number_of_days = parseInt(bloginfobirth / (1000 * 60 * 60 * 24));
document.getElementById('bloginfobirth').innerHTML = number_of_days;
</script>